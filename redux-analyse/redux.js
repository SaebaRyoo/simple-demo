(function (global, factory) {
  ...
  // reducer 就是 combineReducers 的返回值 combination
  // preloadedState是在调用createStore时给的初始state，如果没有则为undefined
  function createStore(reducer, preloadedState, enhancer) {
    ...
    if (typeof enhancer !== 'undefined') {
      ...
      // 将createStore传入, 如果使用了 applyMiddleware 来执行自定义的 中间件
      // 则enhancer就是 applyMiddleware
    ...
    // 在redux中，采用的是发布-订阅模式来监听store的变化
    // subscribe则是一个 订阅装置 
    // 参数 listener 则是 发布
